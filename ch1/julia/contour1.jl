...
# ╔═╡ c98c0b42-1020-11ee-1090-69551c5658e4
using CairoMakie, PlutoUI

# ╔═╡ af5699b1-aa36-44f6-bf8a-a8e8b31776e9
begin
	@bind a  (PlutoUI.Slider(1:0.1:2π, show_value=true))
end

# ╔═╡ d52563cd-4922-4243-9545-d73302171a54
begin
	ellipse(x, y) = ((2x*cos(a) - 3y*sin(a)))^2 + ((2x*sin(a) + 3y*cos(a))/2)^2
	x = y = range(-7, 7; length=100)
	z = ellipse.(x, y')
	...
	ax = Axis(fig[1,1], xlabel = L"x_1", ylabel = L"x_2", 
				xlabelsize = 20, ylabelsize = 20, aspect = DataAspect())
	contour!(x, y, z; labels=true, 
		levels, colormap, linewidth=2,
		labelsize=14)
	limits!(ax, -5, 5, -5, 5)
	text!(0.2,-1, text=L"A", fontsize=24)
...
# ╔═╡ 0144061f-7a02-467b-8cdb-f7bf6ffd49da
save("/mnt/e/OneDrive/Public/workKMUTT/INC Selection Optimization/Lecture2022/images/contour_book1.pdf", fig)
